...
def apply_plot_style(
    ...
    *,
    ...
    if style_norm == "talk":
        ...
        # TRINITY_PLOT_STYLE=talk is set from the environment, so an explicit
        # env override wins over the caller's argument here.
        _env_fs = os.environ.get("TRINITY_PLOT_BASE_FONTSIZE")
        _env_lw = os.environ.get("TRINITY_PLOT_LINEWIDTH")
